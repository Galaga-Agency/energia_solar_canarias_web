  ...
  return (
    <>
      <header
        ...
        className="fixed inset-x-0 top-0 z-70 px-4 pt-3 md:px-6 lg:px-8"
      >
        <div
          className={`relative brand-radius navbar-shell navbar-shell-layout mx-auto flex h-[72px] items-center gap-4 px-5 md:px-6 ${transparent ? "navbar-shell--hero" : "navbar-shell--scrolled"}`}
        >
          <TransitionLink
            href="/"
