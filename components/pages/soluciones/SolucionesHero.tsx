...
export function SolucionesHero({ eyebrow, title, body, items }: SolucionesHeroProps) {
  return (
    <section data-hero className="section-spacing-both" style={{ backgroundColor: 'var(--color-bg)' }}>
      <div className="section-inner">
        ...
        <h1 className="text-title mb-6 max-w-2xl" data-hero-item>{title}</h1>
        <p className="text-body mb-12 max-w-xl" data-hero-item>{body}</p>
