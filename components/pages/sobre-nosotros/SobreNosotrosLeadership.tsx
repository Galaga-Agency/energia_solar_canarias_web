...
export function SobreNosotrosLeadership() {
  ...
  return (
    <section data-founder-section className="relative isolate overflow-hidden bg-[#d8cbb5] section-spacing-both">
      <PaperTexture className="z-0" />

      <div className="section-inner relative z-10 grid grid-cols-1 items-center gap-x-16 gap-y-10 md:grid-cols-12">
        <figure className="relative md:col-span-5">
          {/* Offset green frame behind the portrait (slides into place via animation) */}
          <div className="relative">
            ...
            />
            <div className="relative z-10 aspect-3/4 w-full overflow-hidden bg-[#1f3a34]">
              <Image
        ...
        <div className="md:col-span-7">
          ...
          <blockquote data-founder-quote className="mt-8 border-l-2 border-primary pl-6 text-heading text-ink!">
            “{t('quote')}”
          </blockquote>
