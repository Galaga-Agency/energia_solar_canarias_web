...
export function SobreNosotrosCTA() {
  ...
  return (
    <section data-cta-section className="relative isolate overflow-hidden bg-[#f4f1ea] section-spacing-both">
      ...
      <div className="section-inner relative z-10">
        <div className="flex flex-col gap-8 md:max-w-3xl lg:max-w-4xl">
          ...
          <h2 data-cta-title className="text-display max-w-[20ch]">
            {t('titleLead')}{' '}
            <em className="not-italic md:italic md:font-normal md:text-primary">{t('titleTail')}</em>
          </h2>
          <p data-cta-item className="max-w-[56ch] text-body text-ink/75">{t('body')}</p>
